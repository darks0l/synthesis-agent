...
const projectUUID = 'd4a5a7bb5c5645bc996457b0f1f84757';
...
const body = {
  ...
  videoURL: 'https://github.com/darks0l/synthesis-agent/releases/download/v1.0.0-demo/darksol-full-demo.mp4',
  trackUUIDs: [
    ...
    '49c3d90b1f084c44a3585231dc733f83',
...
const res = await fetch(`https://synthesis.devfolio.co/projects/${projectUUID}`, {
  method: 'POST',
  headers: {
